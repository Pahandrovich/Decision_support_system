...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// zedGraphControl1
			// 
			this->zedGraphControl1->Location = System::Drawing::Point(29, 13);
			...
			this->zedGraphControl1->Size = System::Drawing::Size(378, 324);
			this->zedGraphControl1->TabIndex = 0;
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(519, 349);
			...
			this->label1->Location = System::Drawing::Point(478, 49);
			...
			this->label2->Location = System::Drawing::Point(478, 76);
			...
			this->label3->Location = System::Drawing::Point(615, 49);
			...
			this->label4->Location = System::Drawing::Point(478, 104);
			...
			this->label5->Location = System::Drawing::Point(478, 130);
			...
			this->label6->Location = System::Drawing::Point(615, 76);
			...
			this->label7->Location = System::Drawing::Point(768, 76);
			...
			this->label8->Location = System::Drawing::Point(768, 49);
			...
			this->label9->Location = System::Drawing::Point(768, 102);
			...
			// textBox_a
			// 
			this->textBox_a->Location = System::Drawing::Point(500, 49);
			...
			// textBox_d
			// 
			this->textBox_d->Location = System::Drawing::Point(500, 130);
			this->textBox_d->Name = L"textBox_d";
			this->textBox_d->Size = System::Drawing::Size(100, 22);
			this->textBox_d->TabIndex = 12;
			this->textBox_d->Text = L"1";
			// 
			// textBox_c
			// 
			this->textBox_c->Location = System::Drawing::Point(500, 104);
			...
			// textBox_b
			// 
			this->textBox_b->Location = System::Drawing::Point(500, 77);
			this->textBox_b->Name = L"textBox_b";
			this->textBox_b->Size = System::Drawing::Size(100, 22);
			this->textBox_b->TabIndex = 14;
			this->textBox_b->Text = L"1";
			// 
			// textBox_t
			// 
			this->textBox_t->Location = System::Drawing::Point(633, 49);
			...
			// textBox_TT
			// 
			this->textBox_TT->Location = System::Drawing::Point(633, 77);
			...
			// textBox_r
			// 
			this->textBox_r->Location = System::Drawing::Point(808, 49);
			...
			// textBox_eps
			// 
			this->textBox_eps->Location = System::Drawing::Point(808, 73);
			...
			// textBox_N
			// 
			this->textBox_N->Location = System::Drawing::Point(808, 99);
			...
			this->groupBox1->Location = System::Drawing::Point(445, 185);
			...
			this->groupBox2->Location = System::Drawing::Point(620, 185);
			...
			this->label10->Location = System::Drawing::Point(539, 13);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(826, 335);
			...
			this->label11->Location = System::Drawing::Point(805, 340);
			...
			this->label12->Location = System::Drawing::Point(805, 369);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(826, 366);
			...
			// textdebug
			// 
			this->textdebug->Location = System::Drawing::Point(808, 206);
			...
			this->ClientSize = System::Drawing::Size(994, 445);
